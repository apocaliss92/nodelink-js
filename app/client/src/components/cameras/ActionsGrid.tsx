...
import { Move, Bell, Users, Plug, Bug, Download, Power, Trash2, ScrollText, Network, RotateCw, Camera, Sliders } from 'lucide-react';
  ...
  return (
    <div className="rounded-lg bg-[var(--color-surface)] p-3">
      ...
      <div className="grid grid-cols-2 gap-1.5">
        ...
        <button className={`${btnClass} col-span-2`} onClick={onStreamSettings} disabled={!isConnected}><Sliders size={13} /> Camera settings</button>
